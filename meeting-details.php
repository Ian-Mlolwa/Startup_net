      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8">
          <div class="left-content">
            <p>This is an educational <em>php CSS</em> template by TemplateMo website.</p>
          </div>
        </div>
          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <img src="logo.png" height="50px" width="5px">Edu Meeting
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                ...
                <div class="down-content">
                  ...
                  <p class="description">
                    This is an edu meeting php CSS template provided by <a href="https://templatemo.com/" target="_blank" rel="nofollow">TemplateMo website</a>. This is a Bootstrap v5.1.3 layout. If you need more free website templates like this one, please visit our website TemplateMo. Please tell your friends about our website. Thank you. If you want to get the latest collection of php CSS templates for your websites, you may visit <a rel="nofollow" href="https://www.toocss.com/" target="_blank">Too CSS website</a>. If you need a working contact form script, please visit <a href="https://templatemo.com/contact" target="_parent">our contact page</a> for more info.
